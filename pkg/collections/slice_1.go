...
func (s SliceT0) FlatMapAnyT1(f func(T0) []T1) []T1 {
	return s.FlatMap(f)
}
...
func (s SliceT0) FoldAnyT1(z T1, op func(T1, T0) T1) T1 {
	return s.Fold(z, op)
}

func (s SliceT0) GroupByAnyT1(keySelector func(T0) T1) map[T0][]T1 {
...
func (s SliceT0) MapAnyT1(f func(T0) T1) []T1 {
	return s.Map(f)
}
