...
func TestMap_FlatMapint(t *testing.T) {
	...
	cases := []struct {
		...
		{"FlatMapint: non-empty receiver", mBase(), f, Sliceint{1, 2, 2, 3, 3, 3, 4, 4, 4, 4}},
...
func TestMap_Mapint(t *testing.T) {
	...
	cases := []struct {
		...
		{"Mapint: non-empty receiver", mBase(), f, Sliceint{2, 23, 334, 4445}},
...
func TestMap_MapKeysint(t *testing.T) {
	...
	cases := []struct {
		...
		{"MapKeysint: non-empty receiver", mBase(), f, Mapintstring{2: "w1", 23: "w22", 334: "w333",
			4445: "w4444"}},
...
func TestMap_MapValuesint(t *testing.T) {
	...
	cases := []struct {
		...
		{"MapValuesint: non-empty receiver", mBase(), f, Mapintint{1: 3, 22: 25, 333: 337,
			4444: 4449}},
